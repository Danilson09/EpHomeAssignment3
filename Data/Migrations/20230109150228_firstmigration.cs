    ...
    public partial class firstmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextFileModels", x => x.FileName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AclModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AclModels_TextFileModels_FileName",
                        column: x => x.FileName,
                        principalTable: "TextFileModels",
                        principalColumn: "FileName",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AclModels_FileName",
                table: "AclModels",
                column: "FileName");
